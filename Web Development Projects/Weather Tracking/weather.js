...
const API_KEY = "dc7218caf4284228ae092817250603";
...
const displayHourlyForecast = (hourlyData) => {
    ...
    const next24ours = currentHour + 24 * 60 * 60 * 1000;

    const next24HoursData = hourlyData.filter(({ time }) => {
        const forecastTime = new Date(time).getTime();
        return forecastTime >= currentHour && forecastTime <= next24ours;
    });
